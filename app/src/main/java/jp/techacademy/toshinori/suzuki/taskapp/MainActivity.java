...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText mEditText = (EditText) findViewById(R.id.category_search_text);
    ...
    private void searchListView(String searchText) {
        ...
        if (searchText.isEmpty()) {
            ...
            taskRealmResults = mRealm.where(Task.class).equalTo ("category", searchText).findAllSorted("date", Sort.DESCENDING);
        }
        mTaskAdapter.setTaskList(mRealm.copyFromRealm(taskRealmResults));
        mListView.setAdapter(mTaskAdapter);
        mTaskAdapter.notifyDataSetChanged();
